...
public interface CallLogRepository extends JpaRepository<CallLog, Long> {
    ...
    @Query("""
            ...
            """)
    CallMetricsDTO aggregateCallMetrics(@Param("modelId") Long modelId,
    ...
    @Query("""
            ...
            where (:modelId is null or c.modelId = :modelId)
              ...
              and (:endTime is null or c.createdAt <= :endTime)
            """)
    SuccessRateDTO aggregateSuccessRate(@Param("modelId") Long modelId,
                                        @Param("taskType") String taskType,
                                        @Param("startTime") LocalDateTime startTime,
                                        @Param("endTime") LocalDateTime endTime);
    ...
    @Query("""
            ...
            where (:modelId is null or c.modelId = :modelId)
              ...
              and (:endTime is null or c.createdAt <= :endTime)
            """)
    ResponseTimeDTO aggregateResponseTime(@Param("modelId") Long modelId,
                                          @Param("taskType") String taskType,
                                          @Param("startTime") LocalDateTime startTime,
                                          @Param("endTime") LocalDateTime endTime);
    ...
    @Query("""
            ...
            group by c.modelId
            """)
    List<ModelUsageDTO> aggregateModelUsage(@Param("startTime") LocalDateTime startTime,
                                            @Param("endTime") LocalDateTime endTime);
}
