package com.xbk.knowledge.infrastructure.mapper.rag;
...
public interface RagTaskMapper {
    ...
    long countByOrgIdAndStatus(@Param("orgId") Long orgId, @Param("status") String status);

    long countDistinctRagTagByOrgId(@Param("orgId") Long orgId);

    long countFailedTasksSinceByOrgId(@Param("orgId") Long orgId, @Param("since") LocalDateTime since);
